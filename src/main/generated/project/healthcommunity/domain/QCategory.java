...
public class QCategory extends EntityPathBase<Category> {
    ...
    private static final long serialVersionUID = 895661394L;
    ...
    public final ListPath<CategoryPost, QCategoryPost> postList = this.<CategoryPost, QCategoryPost>createList("postList", CategoryPost.class, QCategoryPost.class, PathInits.DIRECT2);
