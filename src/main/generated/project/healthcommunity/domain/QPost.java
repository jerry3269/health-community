...
public class QPost extends EntityPathBase<Post> {
    ...
    private static final long serialVersionUID = 208001780L;
    ...
    public final ListPath<CategoryPost, QCategoryPost> categoryList = this.<CategoryPost, QCategoryPost>createList("categoryList", CategoryPost.class, QCategoryPost.class, PathInits.DIRECT2);
